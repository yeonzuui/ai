...
public class Speaker implements IVolume {
	...
	private final int MAX_VOLUME = 50; // 볼륨 상한
	private final int MIN_VOLUME = 1;  // 볼륨 하한
	public Speaker() {
		volumeLevel = 3;
	}
	...
	public void volumeUp(int i) { // 볼륨을 i씩 Up
		if(volumeLevel == MAX_VOLUME) {
			...
			System.out.println("스피커 볼륨을 " + temp + "만큼 올려 최대치에 도달했습니다");
		} // if
	} //volumeUp
	...
	public void volumeDown(int i) { // 볼륨을 i씩 Down
		if(volumeLevel == MIN_VOLUME) {
			...
			System.out.println("스피커 볼륨 " + temp + "만큼 내려 최소치에 도달했습니다");
		} // if
	}
} // class
