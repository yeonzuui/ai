...
public class Ex02_StringApiMethod {
	public static void main(String[] args) {
		...
		System.out.println("8. " + str1.indexOf("bc")); // 8. 1: 해당 문자가 처음 오는 인덱스
		String str4 = "abcXabcXabc";
		System.out.println("9. " + str4.indexOf("bc", 2)); // 9. 5: 해당 문자를 2번째부터 검색
		System.out.println("10. " + str4.lastIndexOf("bc")); // 10. 9: 마지막부터 해당 문자열을 검색
		System.out.println("11. " + str4.indexOf("@")); // 11. -1: 없는 문자는 -1 반환
		System.out.println("12. " + str1.equals(str2)); // 12. false
		System.out.println("13. " + str1.equalsIgnoreCase(str2)); // 13. true: 대소문자구별없이 비교
		System.out.println("14. " + str3.trim()); // 14. ja va: 앞뒤 space 제거(로그인)
