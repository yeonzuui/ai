...
//    2. 0~2 사이의 수를 입력 한 경우(if, switch, 삼항연산자)
//          (1)컴퓨터가 0~2 사이의 난수를 발생
//          (2)당신과 컴퓨터가 낸 가위바위보 출력 (ex. 가위, 컴퓨터는 바위 출력)
...
//		default: youStr = "보"; break; // default로 바꿔(0,1 제외는 보로 처리해)
//		}

		// 컴퓨터도 0~2 난수 0 <= Math.randon()*3 < 3
		int com = 1; // 0~2 사이의 정수 난수;
