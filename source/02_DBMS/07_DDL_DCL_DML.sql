...
CREATE TABLE STUDENT(
    ...
    sNAME  VARCHAR2(50),
    sSCORE NUMBER(3)  CHECK (sSCORE >= 1 AND sSCORE <= 100), -- sSCORE BETWEEN 1 AND 100
    mCODE,
    FOREIGN KEY(mCODE) REFERENCES MAJOR(mCODE) -- mCODE NUMBER(2) REFERENCES MAJOR(mCODE)
);
-- 데이터 INSERT
