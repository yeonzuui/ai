...
<body>
	<form action="${conPath }/update2.do" method="post">
		...
		<table>
			...
			<tr>
				<th>생일</th>
				<td><input type="date" name="birth" placeholder="${person.birth }"></td>
			</tr>
			<tr>
				<th>메모</th>
				<td><textarea rows="3" cols="50" name="memo" placeholder="${person.memo }"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="submit" value="수정" class="btn">
					<input type="button" value="수정취소" class="btn"
